...
set -e
ECR_IMAGE="700707367057.dkr.ecr.us-east-1.amazonaws.com/php-demo:latest"
TASK_DEFINITION=$(aws ecs describe-task-definition --task-definition dev-php-demo --region us-east-1)
...
aws ecs update-service --cluster ecs-cluster-php-demo --service service-dev-php-demo --task-definition dev-php-demo:${NEW_REVISION} --region us-east-1
